...
@include('part.nav')
    ...
    <div class="container-fluid bg-primary hero-header mb-5">
        <div class="container text-center">
            <h1 class="display-4 text-white mb-3 animated slideInDown">Заметки</h1>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
					...
					<?php
						$​reflection = '';
						if(count($oneproduct->images) > 0){
							$​reflection = $oneproduct->images[0]['img'];
						} else {
							$​reflection = 'null.jpg';
						}
					?>
					<img class="img-fluid" src="img/{{ $​reflection }}" alt="{{ $oneproduct->title }}">
					<!-- <img class="img-fluid" src="img/{{ $oneproduct->images[0]['img']; }}"> -->
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <h1 class="text-primary mb-4">Fern <span class="fw-light text-dark">is a Symbol of Beauty</span></h1>
                    <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    <p class="mb-4">
						<div class="row align-items-center">
							<div class=" text-center text-lg-start">
								<p class=" text-white  slideInRight">
									<span class="fw-light text-dark"> Count: {{ $firstid }} - {{$lastid}} Fern</span>  
								</p>
								<p class="text-dark slideInRight fw-bold">{{ $oneproduct->id }} 
								<span class="fw-light text-dark">{{$oneproduct->title}}</span> </p>
								<p class="text-dark mb-4  slideInRight">{{$oneproduct->description}}</p>
							</div>
						</div>
					</p>
